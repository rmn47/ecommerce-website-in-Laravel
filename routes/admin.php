...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::resource('wholesellers', WholesellerController::class);
    Route::controller(WholesellerController::class)->group(function () {
        Route::get('wholesellers_ban/{customer}', 'ban')->name('wholesellers.ban');
        Route::get('wholesellers-suspicious/{customer}', 'suspicious')->name('wholesellers.suspicious');
        Route::get('/wholesellers/login/{id}', 'login')->name('wholesellers.login');
        Route::get('/wholesellers/destroy/{id}', 'destroy')->name('wholesellers.destroy');
        Route::post('/bulk-wholeseller-delete', 'bulk_customer_delete')->name('bulk-wholesellers-delete');
    });
