    ...
    <form action="{{ route('seller.profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="gst_no">{{ translate('GST Number') }}</label>
                    <div class="col-md-10">
                        <input type="text" name="gst_no" value="{{ $user->gst_no ?? '' }}" id="gst_no" class="form-control" placeholder="{{ translate('GST Number') }}">
                        @error('gst_no')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="drug_license_no">{{ translate('Drug License Number') }}</label>
                    <div class="col-md-10">
                        <input type="text" name="drug_license_no" value="{{ $user->drug_license_no ?? '' }}" id="drug_license_no" class="form-control" placeholder="{{ translate('Drug License Number') }}">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="pan_card">{{ translate('PAN Card Number') }}</label>
                    <div class="col-md-10">
                        <input type="text" name="pan_card" value="{{ $user->pan_card ?? '' }}" id="pan_card" class="form-control" placeholder="{{ translate('PAN Card Number') }}">
                        @error('pan_card')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
