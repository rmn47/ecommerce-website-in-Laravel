            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Wholesellers') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        @can('view_all_customers')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('wholesellers.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['wholesellers.create'])}}">
                                <span class="aiz-side-nav-text">{{ translate('Wholesellers list') }}</span>
                            </a>
                        </li>
                        @endcan
                        @if(get_setting('classified_product') == 1)
