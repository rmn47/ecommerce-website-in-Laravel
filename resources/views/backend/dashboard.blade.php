                            ...
                            <div class="d-flex flex-column justify-content-between h-100">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <h3 class="fs-13 fw-600 text-secondary mb-0">{{ translate('Total Wholesellers') }}</h3>
                                    </div>
                                    <div class="mt-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                            viewBox="0 0 32 32">
                                ...
                                <div>
                                    <h3 class="fs-13 fw-600 mb-1">
                                        <span class="badge badge-md badge-dot badge-circle badge-danger mr-2"></span>
                                        {{ translate('Top Wholesellers') }}
                                    </h3>
                                    <div class="symbol-group">
                                        @foreach ($top_wholesellers as $top_wholeseller)
                                            <div class="symbol size-40px rounded-content overflow-hidden"
                                                title="{{ $top_wholeseller->name }}">
                                                <img src="{{ uploaded_asset($top_wholeseller->avatar_original) }}"
                                                    alt="{{ translate('customer') }}" class="h-100 img-fit lazyload"
                                                    onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                                            </div>
                                        @endforeach
