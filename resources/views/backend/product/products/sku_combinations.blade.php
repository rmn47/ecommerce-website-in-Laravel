<!-- backend/product/products/sku_combinations.blade.php -->
            ...
            <tr class="variant">
                ...
                <td>
                    <div class="input-group">
                        <input type="number" lang="en" name="discount_{{ $str }}" value="0" min="0" step="0.01" class="form-control" required>
                        <select class="form-control" name="discount_type_{{ $str }}">
                            <option value="amount" selected>{{translate('Flat')}}</option>
