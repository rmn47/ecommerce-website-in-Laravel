            ...
            <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                @if(Auth::user()->is_wholeseller == 1)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control rounded-0" placeholder="{{ translate('Drug License Number') }}" name="drug_license_no" value="{{ Auth::user()->drug_license_no }}">
                        </div>
                    </div>
                    <!-- GST Number -->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control rounded-0" placeholder="{{ translate('GST Number') }}" name="gst_no" value="{{ Auth::user()->gst_no }}">
                        </div>
                    </div>
                @endif
                <!-- Photo-->
