<div class="p-3">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <select class="form-control mb-3 aiz-selectpicker rounded-0" data-live-search="true" name="city_id" onchange="updatePincodes(this.value, 'pincode_select')" required>
                <option value="">{{ translate('Select your city') }}</option>
                @foreach (\App\Models\City::where('status', 1)->whereHas('pincodes', function ($query) {
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <select class="form-control mb-3 aiz-selectpicker rounded-0" id="pincode_select" name="postal_code" data-live-search="true" required>
                <option value="">{{ translate('Select Pincode') }}</option>
                <!-- Pincodes will be populated via JavaScript -->
            </select>
        </div>
    </div>
