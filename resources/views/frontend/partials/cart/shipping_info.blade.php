            ...
            <div class="row">
                <div class="col-md-8">
                    <label class="aiz-megabox d-block bg-white mb-0">
                        <input type="radio" name="address_id" value="{{ $address->id }}" @if ($address->id == $address_id) checked @endif required>
                        <span class="d-flex p-3 aiz-megabox-elem border-0">
                            ...
                            <span class="flex-grow-1 pl-3 text-left">
                                ...
                                <div class="row">
                                    <span class="fs-14 text-secondary col-md-3 col-5">{{ translate('Pincode') }}</span>
