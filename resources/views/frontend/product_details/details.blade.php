<div class="text-left">
    <!-- Product Name -->
    <h2 class="mb-4 fs-13 fw-700 text-dark">
    ...
    @else
        ...
        @else
            <!-- Non-Wholesale Pricing with Dynamic Variant Discounts -->
            <div class="row no-gutters mb-3" id="variant-price-section">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                    <div class="d-flex align-items-center">
                        <!-- Discounted Price -->
                        <strong class="fs-16 fw-700 text-primary" id="variant-discounted-price">
                            {{ home_discounted_price($detailedProduct) }} <!-- Default value -->
                        </strong>
                        <!-- Original Price (if discounted) -->
                        <del class="fs-14 opacity-60 ml-2" id="variant-original-price"
                            @if (home_price($detailedProduct) == home_discounted_price($detailedProduct)) style="display: none;" @endif>
                            {{ home_price($detailedProduct) }} <!-- Default value -->
                        </del>
                        <!-- Unit -->
                        @if ($detailedProduct->unit != null)
                        ...
                        @endif
                        <!-- Discount Percentage -->
                        <span class="bg-primary ml-2 fs-11 fw-700 text-white w-35px text-center p-1" id="variant-discount-percentage"
                            style="padding-top:2px;padding-bottom:2px; @if (discount_in_percentage($detailedProduct) <= 0) display: none; @endif">
                            -{{ discount_in_percentage($detailedProduct) }}% <!-- Default value -->
                        </span>
                        <!-- Club Point -->
    ...
    @if ($detailedProduct->auction_product != 1)
        <form id="option-choice-form">
            ...
            <input type="hidden" name="discounted_price" id="discounted_price_input" value="{{ home_discounted_price($detailedProduct) }}">
                    ...
                    <div class="col-sm-10">
                        <div class="product-quantity d-flex align-items-center">
                            <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 130px;">
                                ...
                                <input type="number" name="quantity" class="col border-0 text-center flex-grow-1 fs-16 input-number"
                                    placeholder="1" value="{{ $detailedProduct->min_qty }}" min="{{ $detailedProduct->min_qty }}"
                                    max="10" lang="en">
                                <button class="btn col-auto btn-icon btn-sm btn-light rounded-0" type="button"
            ...
            <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                ...
                <div class="col-sm-10">
                    <div class="product-price">
                        <strong id="chosen_price" class="fs-15 fw-700 text-primary"></strong>
                    </div>
                </div>
            </div>
        </form>
