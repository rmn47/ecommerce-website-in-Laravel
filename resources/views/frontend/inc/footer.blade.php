            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        @else
                            <li class="mb-2">
                                <a class="fs-13 text-soft-light animate-underline-white" href="javascript:void(0)" onclick="showLoginModal()">
                                    {{ translate('Login') }}
                                </a>
                            </li>
                        @endif
                    ...
                    <ul class="list-unstyled mt-3">
                        ...
                        @else
                            <li class="mb-2 pb-2 {{ areActiveRoutes(['user.login'],' active')}}">
                                <a class="fs-13 text-soft-light text-sm-secondary animate-underline-white" href="javascript:void(0)" onclick="showLoginModal()">
                                    {{ translate('Login') }}
                                </a>
                            </li>
                        @endauth
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col">
            @if (Auth::check())
                ...
                @endif
            @else
                <a href="javascript:void(0)" onclick="showLoginModal()" class="text-secondary d-block text-center pb-2 pt-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
