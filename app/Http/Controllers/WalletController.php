...
class WalletController extends Controller
{
    ...
    public function recharge(Request $request)
    {
        ...
        // Explicitly set payment_type and user_id in the request
        $request->merge([
        ...
        if ($request->payment_option === 'phonepe') {
            return (new ApiPhonepeController)->pay($request);
        }
        ...
        return redirect()->route('wallet.index')->with('error', 'Selected payment method is not available.');
    }
