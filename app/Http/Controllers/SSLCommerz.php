...
class SSLCommerz
{
    ...
    public function __construct()
    {
        ...
        $this->sslc_submit_url = env('SSLCZ_SUBMIT_URL', "https://" . $this->sslc_mode . ".sslcommerz.com/gwprocess/v3/api.php");
        $this->sslc_validation_url = env('SSLCZ_VALIDATION_URL', "https://" . $this->sslc_mode . ".sslcommerz.com/validator/api/validationserverAPI.php");
    }
