...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        $discounted_price = $request->has('discounted_price') 
            ? floatval(str_replace([get_system_default_currency()->symbol, ' '], '', $request->input('discounted_price'))) 
            : null;
    
        $price = CartUtility::get_price($product, $product_stock, $quantity, $discounted_price);
